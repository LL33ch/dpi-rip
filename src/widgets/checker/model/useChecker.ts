...
import type { CategoryResult, SiteResult, SiteStatus } from '@shared/model';
import { CONFIG } from '@shared/config';
import { checkSite, checkDpiProvider, checkCdnTrace } from '@shared/api';
import { saveTestRun } from '@shared/lib';
...
export function useChecker() {
  ...
  return { categories, isChecking, checkedCount, totalCount, runChecks };
}
